            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body col-md-12">
                        ...
                        @endif
                        <form action="/save_business_photo" method="post" autocomplete="off"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div clas="file_input_wrap">
                                            <input type="file" name="imageUpload" accept="image/*" id="imageUpload"
                                                class="hide" />
                                            <label for="imageUpload" class="photobtn photobtn-large">Select
                                                file..</label>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="img_preview_wrap">
                                        <img src="" id="imagePreview" alt="Preview Image" width="200px" height="200px"
                                            class="hide" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="card m-2">
                                        <div class="card-body">
                                            <div class="img-wrap">
                                                <span class="close fordel"
                                                    data-id="{{$allbusinessphoto->id}}">&times;</span>
                                                <img class="card-img-top"
                                                    src="/storage/images/business_photo/{{ $allbusinessphoto->image }}"
                                                    style="width: 226px; height: 200px">
                                            </div>
                                            <p class="card-text text-center my-1" style="text-transform: capitalize;">
                                                {{$allbusinessphoto->title}}
                                            </p>
                                        </div>
                                    </div>
                                </div>
