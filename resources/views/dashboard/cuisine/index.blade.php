...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-10">
					<h3 class="page-title">Manage Cuisines</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="/home">Dashboard</a></li>
						<li class="breadcrumb-item active">Manage Cuisines</li>
					</ul>
				</div>
				
				<div class="panel-heading col-md-2">
					@can('cuisine.write')
           				 <a href="{{ route('cuisine.create')}}" class="btn btn-block btn-primary">Add Cuisine</a>
           			@endcan
        		</div>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<div class="actions">
													@can('cuisine.write')
													<a href="{{ route('cuisine.edit',$val->id) }}" class="btn btn-sm bg-success-light mr-2">
														 <i class="fa fa-pencil-square-o text-success"></i>
													</a>
													@endcan
													@can('cuisine.delete')
													<form method="post" action="{{route('cuisine.destroy',$val->id)}}" style="display: inline-block;">
													@csrf
													@method('DELETE')
