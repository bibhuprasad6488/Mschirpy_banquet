...
<div class="page-wrapper">
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-sm-12">
							<h3 class="page-title">Welcome to vendor Admin!</h3>
							<ul class="breadcrumb">
							...
							<div class="card-body">
								<ul class="activity-feed">
									<li class="feed-item">
										...
										<span class="feed-text"><a href="profile.html">John Doe</a> added new product <a
												href="product-details.html">"Smart Watch"</a></span>
									</li>
									<li class="feed-item">
										<div class="feed-date">Mar 21</div>
										<span class="feed-text"><a href="profile.html">Justin Lee</a> requested amount
											of <a href="invoice.html">$5,781</a></span>
									</li>
									<li class="feed-item">
										<div class="feed-date">Feb 2</div>
										<span class="feed-text">New user registered <a href="profile.html">"Mary
												Wiley"</a></span>
									</li>
									<li class="feed-item">
