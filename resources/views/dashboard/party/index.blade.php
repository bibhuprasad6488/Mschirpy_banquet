...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-10">
					<h3 class="page-title">Manage parties</h3>
					<ul class="breadcrumb">
				...
				<div class="panel-heading col-md-2">
           				 ...
           				 <a href="{{ route('party.create')}}" class="btn btn-block btn-primary">Add party</a>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<div class="actions">
													<a href="{{ route('party.edit',$val->id) }}" class="btn btn-sm bg-success-light mr-2">
														 <i class="fa fa-pencil-square-o text-success"></i>
													</a>
													<form method="post" action="{{route('party.destroy',$val->id)}}" style="display: inline-block;">
													@csrf
													@method('DELETE')
