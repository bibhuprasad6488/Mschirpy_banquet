            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="panel-heading col-md-2">
                        {{-- @can('content.write') --}}
                        <a href="/faq_create" class="btn btn-block btn-primary">Add FaQ</a>
                        {{-- @endcan --}}
                    </div>
                                            ...
                                            @foreach ($faq as $key => $val)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="actions">
                                                            {{-- @can('pages.write') --}}
                                                            <a href="/faq_edit/{{ $val->id }}"
                                                                class="btn btn-sm bg-success-light m-1 " style="padding:3px;">
                                                                 <i class="fa fa-pencil-square-o text-success pt-1"></i>
                                                            </a>
                                                            <form method="post" action="/faq_delete"
