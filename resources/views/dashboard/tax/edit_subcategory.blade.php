                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="subcategory" name="subcategory" class="form-control"
                                                placeholder="Sub Category Name" required value="{{ $subcat->subcat }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status">
                                                ...
                                                <option value="inactive"
                                                    {{ $subcat->status == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
