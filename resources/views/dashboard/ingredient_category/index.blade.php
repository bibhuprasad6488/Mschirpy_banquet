...
<div class="page-wrapper">
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-10">
					<h3 class="page-title">Manage Ingredient Categories</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="/home">Dashboard</a></li>
						<li class="breadcrumb-item active">Manage Ingredient Categories</li>
					</ul>
				</div>
				
				<div class="panel-heading col-md-2">
			
           				 <a href="{{ route('ingredient_category.create')}}" class="btn btn-block btn-primary">Add Category</a>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<div class="actions">
													<a href="{{ route('ingredient_category.edit',$val->id) }}" class="btn btn-sm bg-success-light mr-2">
													 <i class="fa fa-pencil-square-o text-success"></i>
													</a>
													<form method="post" action="{{route('ingredient_category.destroy',$val->id)}}" style="display: inline-block;">
													@csrf
													@method('DELETE')
...
function changestatus_chk(id,sts)
{
	...
	.then((result) => {
	  if (result.isConfirmed) {
	  	$.ajax({
		type:"POST",
		url:"/ingredient_category_status",
