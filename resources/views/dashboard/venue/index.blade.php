                            ...
                            <table class="datatable table table-stripped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="viewItem" data-id="{{ $val->id }}"><span
                                        ...
                                        <td>
                                            <a href="#" class="viewAmenity" data-id="{{ $val->id }}"><span
                                                    class="badge badge-dark">View Amenities</span></a>
                                        </td>
                                        <td data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="{{ $val->custom_fields['address'] ?? '' }}">
                                            {{ Str::words($val->custom_fields['address'] ?? '', 2, ' ...')}}
                                        </td>
                                        <td>
                                            @if ($val->status == 1)
                                        ...
                                        <td class="text-center">
                                            <div class="actions">
                                                ...
                                                @endcan
                                                @can('venues.delete')
                                                <form method="post" action="{{ route('venue.destroy', $val->id) }}"
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data, function(key, val) {
                $('#modalBody').append(
                    '<div class="col-xl-4 col-sm-6 col-12"><div class="product"><div class="product-inner"><img alt="alt" src="/storage/images/venues/' +
