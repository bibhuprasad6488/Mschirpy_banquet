										...
										<tr>
											...
											<td >
												<div class="actions">
													...
													@endcan
													@can('items.delete')
													<form method="post" action="{{route('menu.destroy',$val->id)}}" style="display: inline-block;">
													@csrf
													@method('DELETE')
													<a type="button" name="del" id="del" class="btn btn-sm bg-danger-light dele text-right"><i class="fe fe-trash"></i> Delete </a>
													</form>
													@endcan
												</div>
											</td>
